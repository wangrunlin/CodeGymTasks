...
public class Tree {
    ...
    public void info(Number n) {
        System.out.println(String.format("Tree 编号 %d，Number 方法，参数: %s", number, n.getClass().getSimpleName()));
    }

    public void info(String str) {
        System.out.println(String.format("Tree 编号 %d，String 方法，参数: %s", number, str.getClass().getSimpleName()));
    }
}
